    ...
    if is_spv:
      ...
      <div style="background:#f0f7ff;border:1px solid #cce0ff;border-radius:8px;padding:14px 16px;margin-bottom:20px">
        ...
        <div class="field-row">
          ...
          <div class="field" style="margin-bottom:0">
            <label>Mgmt Fee (%) <span style="color:#b91c1c">*</span></label>
    ...
    <form method="POST">
      ...
      <div class="field-row" style="margin-bottom:20px">
        <div class="field" style="margin-bottom:0">
          ...
          <p style="font-size:12px;color:#888;margin:4px 0 0 0;">Buyers searching below this amount won't see your deal.</p>
        </div>
        <div class="field" style="margin-bottom:0">
